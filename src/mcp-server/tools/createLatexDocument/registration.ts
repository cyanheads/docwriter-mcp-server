...
export const registerCreateLatexDocumentTool = async (
  ...
  const toolDescription =
    "Bootstraps a new, structured document from a template. Creates a new .tex file from a template, populating metadata placeholders. The full content of the template file, including all defined content blocks, is returned.";
